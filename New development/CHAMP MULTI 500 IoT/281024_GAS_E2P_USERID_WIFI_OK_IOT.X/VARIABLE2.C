...
unsigned char power_ON_delay_f=1;
...
unsigned int  AN2_ADCValue=0,AN3_ADCValue=0,result_AN2=0,adc_cnt=0,adccurrent=0,adcvoltage=0,result_AN3=0; 
...
//unsigned char transtowifi,,cWifidata_recvf,fisttimesend,,Wifi_arr[100],val=0,cWifi_Responsef=0;
//unsigned char cWifi_dataf=0,cWificnt=0;

unsigned char high=0, low=0,middle=0,highest=0,ucnt=0,tcnt=0,cCount_15Sec=0;
unsigned int  tempvalue=0;
unsigned char cdatafrom_Wifi=0,send_ATcmd=0,ucPcnt=0,ucPIndex=0,ucPass=0,WIFIRST=0;
...
unsigned char rec_arr[6]={0};
unsigned char rec_arr1[14]={0};
unsigned int k=0,sendvtg=0,sendcur=0,dummy1=0,dummy2=0,pwmtime1=0,weldcurrent=0,SetVoltage=0,IOT_control_flag=0;
unsigned int SetCurrent=0,SetWiSpeed=0,Gas_result=0;
unsigned char Wifidata[10];
unsigned char model=0,errflag1='N',errflag2='N',ucSend_RemoteToPS=0,ucSend_PSToRemote=0,WifiSend=0,index=0;
unsigned char IoT_reccnt=0,ucIOTSendFlag=0,recstrtpt_Iot=0,ucIoTDataCheck=0,ucIOTcheck=0,IOT_control=0;
volatile unsigned char rec_arr_IoT[55]={0};
unsigned char ucPROG=0,ucMode=0,ucWireDiameter=0,ucGas=0,ucMaterial=0,ucAuto_MANUAL=0,ucArcForceON_OFF=0;
unsigned char ucLockDisable=0;
unsigned char ucWS[4]={0};
unsigned char ucSetV[4]={0};
unsigned char ucArc_Force[4]={0};
unsigned char ucMMA_Current[4]={0};
unsigned char ucTIG_Current[4]={0};
unsigned char ucPassword[4]={0};
unsigned char ucRJ[3]={0};
unsigned char ucSJ[3]={0};
            

//unsigned char ucRxPass[]={0}; //15
unsigned char ucRxPass[20]="admin,ador@123";
//unsigned char ucRxPass[20]="TDC,Ad0r#2024TDC";
//unsigned char userID_PWD[20];
